...
- `arcgis.R`: `arcgis_json(req)` performs an ArcGIS REST query and retries both dropped connections and ArcGIS errors returned inside an HTTP 200 body. Use it for every ArcGIS fetch (311, permits, parcels).
